...
function SignaturePad (selector, options) {
  ...
  function onFormError (errors, context, settings) {
    ...
    if (! errors.accepted)
      context.prepend(['<p class="', settings.errorClass, '">', settings.errorMessageNotAccepted, '</p>'].join(''))
  }
  ...
  function validateForm () {
    var valid = true
      , errors = {accepted: true, drawInvalid: false, nameInvalid: false}
...
$.fn.signaturePad.defaults = {
  ...
  , errorMessageNotAccepted : 'Please accept terms and conditions' // The error message displayed when T&C not accepted
