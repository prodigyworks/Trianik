...
CREATE TABLE `trianik_diary` (
  ...
  KEY `clientid` (`clientid`),
  KEY `memberid` (`memberid`)
) ENGINE=InnoDB AUTO_INCREMENT=76766 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
INSERT INTO trianik_loginaudit VALUES("1231","1","2016-01-11 14:32:38","","2016-01-11 14:32:38","1","2016-01-11 14:32:38","1");
...
INSERT INTO trianik_members VALUES("1","System","Manager","System Manager","admin","21232f297a57a5a743894a0e4a801fc3","kevin.hilton@prodigyworks.co.uk","","","28","",0x,"2016-01-04 16:03:54","Y","","","Y","","","55debe838f30f","07913901614","","","0000-00-00 00:00:00",0x,0x,0x,0x,"1231","0","0","2015-08-27 07:38:43","1","2016-01-11 14:32:38","1");
