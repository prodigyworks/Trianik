...
CREATE TABLE `trianik_diary` (
  ...
  KEY `clientid` (`clientid`),
  KEY `memberid` (`memberid`)
) ENGINE=InnoDB AUTO_INCREMENT=76954 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `trianik_errors` (
  ...
  `metamodifieduserid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=28260 DEFAULT CHARSET=latin1;
...
INSERT INTO trianik_loginaudit VALUES("1233","1","2016-07-28 11:12:35","","2016-07-28 11:12:35","1","2016-07-28 11:12:35","1");
...
INSERT INTO trianik_members VALUES("1","System","Manager","System Manager","admin","21232f297a57a5a743894a0e4a801fc3","kevin.hilton@prodigyworks.co.uk","","","28","",0x,"2016-03-21 12:16:04","Y","","","Y","","","55debe838f30f","07913901614","","","0000-00-00 00:00:00",0x,0x,0x,0x,"1233","0","0","2015-08-27 07:38:43","1","2016-07-28 11:12:35","1");
