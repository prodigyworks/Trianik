...
CREATE TABLE `trianik_errors` (
  ...
  `metamodifieduserid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=28245 DEFAULT CHARSET=latin1;
...
INSERT INTO trianik_loginaudit VALUES("1230","1","2016-01-04 16:03:41","","2016-01-04 16:03:41","1","2016-01-04 16:03:41","1");
...
INSERT INTO trianik_members VALUES("1","System","Manager","System Manager","admin","21232f297a57a5a743894a0e4a801fc3","kevin.hilton@prodigyworks.co.uk","","","28","",0x,"2015-11-20 17:25:27","Y","","","Y","","","55debe838f30f","07913901614","","","0000-00-00 00:00:00",0x,0x,0x,0x,"1230","0","0","2015-08-27 07:38:43","1","2016-01-04 16:03:41","1");
