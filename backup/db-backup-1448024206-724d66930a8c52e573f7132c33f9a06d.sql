...
CREATE TABLE `trianik_diary` (
  ...
  KEY `clientid` (`clientid`),
  KEY `memberid` (`memberid`)
) ENGINE=InnoDB AUTO_INCREMENT=76671 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
INSERT INTO trianik_loginaudit VALUES("1229","1","2015-11-20 12:56:43","","2015-11-20 12:56:43","1","2015-11-20 12:56:43","1");
...
INSERT INTO trianik_members VALUES("1","System","Manager","System Manager","admin","21232f297a57a5a743894a0e4a801fc3","kevin.hilton@prodigyworks.co.uk","","","28","",0x,"2015-11-05 17:28:40","Y","","","Y","","","55debe838f30f","07913901614","","","0000-00-00 00:00:00",0x,0x,0x,0x,"1229","0","0","2015-08-27 07:38:43","1","2015-11-20 12:56:43","1");
