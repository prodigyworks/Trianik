...
CREATE TABLE `trianik_errors` (
  ...
  `metamodifieduserid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=28231 DEFAULT CHARSET=latin1;
...
INSERT INTO trianik_loginaudit VALUES("1224","1","2015-10-16 13:35:00","","2015-10-16 13:35:00","1","2015-10-16 13:35:00","1");
...
INSERT INTO trianik_members VALUES("1","System","Manager","System Manager","admin","21232f297a57a5a743894a0e4a801fc3","kevin.hilton@prodigyworks.co.uk","","","28","",0x,"2015-10-13 11:02:57","Y","","","Y","","","55debe838f30f","07913901614","","","0000-00-00 00:00:00",0x,0x,0x,0x,"1224","0","0","2015-08-27 07:38:43","1","2015-10-16 13:35:00","1");
